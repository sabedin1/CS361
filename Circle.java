...
public class Circle extends GraphicObject {
	...
	// overloaded method in Circle
	// Not overridden as it does not follow the signature in GraphicObject
	...
	public boolean equals(Object obj) {
		...
		return Double.compare(circle.centerX, centerX) == 0 && Double.compare(circle.centerY, centerY) == 0
